/**
 * Test different random numbers with Math.random()
 */
...
class Random {
    public static void main(String[] args) {
        ...
        System.out.println("Here is a random number between 0 and 9: " + random2);

        // Generate a random integer between 0 and 2 (inclusive)
        int random3 = (int)(Math.random() * 10) % 3;
        System.out.println("Here is a random number between 0 and 2: " + random3);
    }
}